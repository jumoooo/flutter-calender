...
class ErrorMessages {
  ...
  /// Hive 초기화 실패
  static const String hiveInitFailed = 
      '데이터 저장소를 초기화할 수 없습니다.\n앱을 재시작해주세요.';
  ...
  /// 데이터 삭제 실패
  static const String dataDeleteFailed = 
      '데이터를 삭제할 수 없습니다.\n다시 시도해주세요.';
  
  /// 데이터 마이그레이션 실패
  static const String migrationFailed = 
      '데이터 형식을 업데이트할 수 없습니다.\n앱을 재시작해주세요.';

  // ========== 할일 관련 에러 ==========
  
  /// 할일 추가 실패
  static const String todoAddFailed = 
      '할일을 추가할 수 없습니다.\n다시 시도해주세요.';
  
  /// 할일 수정 실패
  static const String todoUpdateFailed = 
      '할일을 수정할 수 없습니다.\n다시 시도해주세요.';
  
  /// 할일 삭제 실패
  static const String todoDeleteFailed = 
      '할일을 삭제할 수 없습니다.\n다시 시도해주세요.';
  
  /// 할일 완료 상태 변경 실패
  static const String todoToggleFailed = 
      '할일 상태를 변경할 수 없습니다.\n다시 시도해주세요.';
  ...
  /// JSON 파싱 실패
  static const String jsonParseFailed = 
      '데이터 형식이 올바르지 않습니다.\n손상된 데이터는 건너뛰었습니다.';
  
  /// 날짜 파싱 실패
  static const String dateParseFailed = 
      '날짜 형식이 올바르지 않습니다.';
